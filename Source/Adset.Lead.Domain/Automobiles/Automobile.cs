...
public sealed class Automobile : Entity
{
    ...
    public OptionalFeatures Features { get; private set; }
    ...
    public Result Update(string brand, string model, string plate, string color, decimal price,
        OptionalFeatures features, List<Photo> photos)
    {
        if (Id == Guid.Empty)
